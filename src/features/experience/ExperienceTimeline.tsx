...
const experiences: TimelineItem[] = [
  {
    ...
    type: 'work',
    details: [
      'Создаем B2B SaaS для автоматизации контент-маркетинга: генерация текстов и изображений для соцсетей с помощью Claude. Довели продукт от идеи до MVP за месяц, вышли на 10+ клиентов в бета-тестировании',
      'Спроектировал и реализовал микросервисную архитектуру из 8 сервисов на Python FastAPI',
      'Разработал уникальную механику "обучения рубрик" — AI совместно с человеком достигают эталонного результата, который затем воспроизводится автоматически',
      ...
      'Интегрировал автоматическую нарезку YouTube-видео на highlights с помощью Vizard.ai и систему публикации в соцсети (VK, Instagram, YouTube, Telegram) одной кнопкой',
    ...
    metrics: [
      ...
      { label: 'Микросервисы', value: '8 шт' },
      { label: 'Клиенты', value: '10+' },
      { label: 'MVP', value: '1.5 мес' }
    ]
  },
  {
    id: '2',
    ...
    details: [
      ...
      'Определил границы взаимодействия между отделами (менеджеры, frontend, backend, дизайн) и установил стандарты разработки: DDD, Onion Architecture, Event-Driven, code style guides, API guidelines, автоматизированное тестирование',
