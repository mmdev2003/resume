...
const experiences: TimelineItem[] = [
  {
    ...
    type: 'work',
    details: [
      'Создаем B2B SaaS для автоматизации контент-маркетинга: генерация текстов и изображений для соцсетей с помощью. Довели продукт от идеи до MVP за 2 месяца и вышли на 10+ клиентов в бета-тестировании',
  ...
  },
  {
    ...
    type: 'work',
    details: [
      'Прошел путь от уверенного Junior+ до TechLead за 4 года в качестве сo-founder и разработчика. Вырастили компанию с 3 человек до 25 сотрудников и довели оборот с 0 до 50 млн рублей в год',
      ...
      'Спроектировал и реализовал 8 крупных проектов в различных доменах.',
    ],
    metrics: [
